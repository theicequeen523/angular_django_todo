...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding field 'Ingredient.location'
        db.add_column(u'public_ingredient', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.color'
        db.add_column(u'public_ingredient', 'color',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.flavor'
        db.add_column(u'public_ingredient', 'flavor',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.glyc_index'
        db.add_column(u'public_ingredient', 'glyc_index',
        ...
        # Changing field 'Ingredient.link'
        db.alter_column(u'public_ingredient', 'link',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Ingredient.location'
        db.delete_column(u'public_ingredient', 'location')

        # Deleting field 'Ingredient.color'
        db.delete_column(u'public_ingredient', 'color')

        # Deleting field 'Ingredient.flavor'
        db.delete_column(u'public_ingredient', 'flavor')

        # Deleting field 'Ingredient.glyc_index'
        db.delete_column(u'public_ingredient', 'glyc_index')
