...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'public_recipe', 'description',
                      self.gf('django.db.models.fields.CharField')(default='recipe description null', max_length=100),
                      keep_default=False)


        # Changing field 'Recipe.instruction'
        db.alter_column(u'public_recipe', 'instruction',
                        self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))
    ...
    models = {
        ...
        u'public.recipe': {
            ...
            'instruction': (
            'django.db.models.fields.CharField', [], {'max_length': '10000', 'null': 'True', 'blank': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'prep_time': (
